(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[5009, 959, 6437], {
    497754: (e,t)=>{
        var n;
        !function() {
            "use strict";
    ...
    778199: (e,t,n)=>{
        ...
        function o(e, t, n, o, r) {
            ...
            return r.click && o.addEventListener("click", a, !1),
    ...
    664332: (e,t,n)=>{
        ...
        function l(e, t=[]) {
            ...
            u.current = n;
            const c = (0,
            i.useFunctionalRefObject)(l)
              , d = (0,
            o.useCallback)((e=>{
                c(e),
                null !== s.current && (s.current.disconnect(),
                null !== e && s.current.observe(e))
            }
            ), [c, s]);
            return (0,
            a.useIsomorphicLayoutEffect)((()=>(s.current = new r.default(((e,t)=>{
                u.current(e, t)
            }
            )),
    ...
    533408: (e,t,n)=>{
        ...
        var p = n(206594)
          ...
          , _ = n(869827);
        function C(e) {
            const {title: t, titleTextWrap: n=!1, subtitle: r, showCloseIcon: a=!0, onClose: i, onCloseButtonKeyDown: s, renderBefore: u, renderAfter: c, draggable: d, className: m, unsetAlign: h, closeAriaLabel: f, closeButtonReference: p} = e
              , [v,C] = (0,
            o.useState)(!1);
            return o.createElement(g.DialogHeaderContext.Provider, {
                value: {
                    setHideClose: C
                }
            }, o.createElement("div", {
                className: l()(_.container, m, (r || h) && _.unsetAlign)
            }, u, o.createElement("div", {
                "data-dragg-area": d,
                className: _.title
            }, o.createElement("div", {
                className: l()(n ? _.textWrap : _.ellipsis)
            }, t), r && o.createElement("div", {
                className: l()(_.ellipsis, _.subtitle)
            }, r)), c, a && !v && o.createElement("button", {
                className: _.close,
                onClick: i,
                onKeyDown: s,
                "data-name": "close",
        ...
        class L extends o.PureComponent {
            constructor() {
                ...
                this._renderChildren = (e,t)=>(this._controller = e,
                this.props.render({
                ...
                ,
                this._handleOpen = ()=>{
                    void 0 !== this.props.onOpen && this.props.isOpened && this.props.onOpen(this.props.fullScreen || window.matchMedia(m.DialogBreakpoints.TabletSmall).matches)
                }
                ,
                this._handleKeyDown = e=>{
                    if (!e.defaultPrevented) {
                        ...
                        )(this.props.disableTabNavigationContainment) || (n = e,
                        [9, s.Modifiers.Shift + 9].includes((0,
                        s.hashFromEvent)(n)) && n.stopPropagation())
                    }
                }
                ,
                this._requestResize = ()=>{
            ...
            componentDidMount() {
                ...
                this._handleOpen(),
                void 0 !== this.props.onOpen && (this._orientationMediaQuery = window.matchMedia("(orientation: portrait)"),
                (0,
                a.mediaQueryAddEventListener)(this._orientationMediaQuery, this._handleOpen))
            }
            componentWillUnmount() {
                this.props.ignoreClosePopupsAndDialog || v.unsubscribe(p.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
                null !== this._orientationMediaQuery && (0,
                a.mediaQueryRemoveEventListener)(this._orientationMediaQuery, this._handleOpen)
            }
            focus() {
                (0,
                r.ensureNotNull)(this._reference).focus()
            }
            getElement() {
            ...
            render() {
                const {className: e, wrapperClassName: t, headerClassName: n, isOpened: r, title: a, titleTextWrap: i, dataName: s, onClickOutside: u, additionalElementPos: p, additionalHeaderElement: v, backdrop: y, shouldForceFocus: g=!0, shouldReturnFocus: b, showSeparator: _, subtitle: L, draggable: D=!0, fullScreen: x=!1, showCloseIcon: N=!0, rounded: A=!0, isAnimationEnabled: M, growPoint: z, dialogTooltip: R, unsetHeaderAlign: T, onDragStart: F, dataDialogName: I, closeAriaLabel: B, containerAriaLabel: P, reference: O, containerTabIndex: j, closeButtonReference: Z, onCloseButtonKeyDown: H} = this.props
                  , W = "after" !== p ? v : void 0
                  , K = "after" === p ? v : void 0
                  , q = "string" == typeof a ? a : I || ""
                  , Y = (0,
                w.mergeRefs)([this._handleReference, O]);
                return o.createElement(h.MatchMedia, {
                    rule: m.DialogBreakpoints.SmallHeight
                }, (p=>o.createElement(h.MatchMedia, {
                    rule: m.DialogBreakpoints.TabletSmall
                }, (m=>o.createElement(c.PopupDialog, {
                    rounded: !(m || x) && A,
                    className: l()(E.dialog, e),
                    isOpened: r,
                    reference: Y,
                ...
                }), _ && o.createElement(d.Separator, {
                    className: E.separator
                }), o.createElement(f.PopupContext.Consumer, null, (e=>this._renderChildren(e, m || x)))))))))
            }
        }
    }
    ,
    73572: (e,t,n)=>{
        ...
        var c = n(412228);
        function d(e) {
            const {title: t, subtitle: n, removeBtnLabel: r, onClick: d, onClickFavorite: h, onClickRemove: f, isActive: p, isSelected: v, isFavorite: y, isMobile: g=!1, showFavorite: b=!0, ..._} = e;
            return o.createElement(u, {
                ..._,
                className: a()(c.itemRow, p && !v && c.active, g && c.mobile, v && c.selected),
                onClick: m.bind(null, d),
                "data-role": "list-item",
                "data-active": p
            }, b && h && o.createElement(l.FavoriteButton, {
                className: a()(c.favoriteButton, y && c.favorite, i.CheckMobile.any() && c.mobile),
                isActive: p && !v,
                isFilled: y,
                ...
                className: a()(c.itemInfo, !b && c.itemInfoWithPadding)
            }, o.createElement("div", {
                className: a()(c.title, p && !v && c.active, g && c.mobile),
                "data-name": "list-item-title"
            }, t), o.createElement("div", {
                className: a()(c.details, p && !v && c.active, g && c.mobile)
            }, n)), o.createElement(s.RemoveButton, {
    ...
    231862: (e,t,n)=>{
        ...
        var o = n(50959)
          ...
          , u = n(140281);
        function c(e) {
            const {children: t, renderInput: r, onCancel: c, containerClassName: m, inputContainerClassName: h, iconClassName: f, ...p} = e;
            return o.createElement("div", {
                className: a()(u.container, m)
            }, o.createElement("div", {
                className: a()(u.inputContainer, h, c && u.withCancel)
            }, r || o.createElement(d, {
                ...p
            })), t, o.createElement(l.Icon, {
        ...
        function d(e) {
            const {className: t, reference: n, value: r, onChange: i, onFocus: l, onBlur: s, onKeyDown: c, onSelect: d, placeholder: m, ...h} = e;
            return o.createElement("input", {
                ...h,
                ref: n,
                type: "text",
                className: a()(t, u.input),
                autoComplete: "off",
                "data-role": "search",
                placeholder: m,
                value: r,
    ...
    73288: (e,t,n)=>{
        ...
        const u = n(977253);
        function c(e) {
            const {size: t, scrollSize: n, clientSize: r, scrollProgress: c, onScrollProgressChange: d, horizontal: m, theme: h=u, onDragStart: f, onDragEnd: p, minBarSize: v=40} = e
              , y = (0,
            o.useRef)(null)
              , g = (0,
            o.useRef)(null)
            ...
            o.useEffect)((()=>{
                const e = (0,
                i.ensureNotNull)(y.current).ownerDocument;
                return b ? (f && f(),
                e && (e.addEventListener("mousemove", D),
                e.addEventListener("mouseup", x))) : p && p(),
                ()=>{
                    e && (e.removeEventListener("mousemove", D),
            ...
            return o.createElement("div", {
                ref: y,
                className: a()(h.wrap, m && h["wrap--horizontal"]),
                style: {
                    [m ? "width" : "height"]: t
                },
                onMouseDown: function(e) {
                    ...
                    e.preventDefault();
                    const o = (0,
                    i.ensureNotNull)(g.current).getBoundingClientRect();
                    C.current = (m ? o.width : o.height) / 2;
                    const r = n - t;
                    let a = N(e.nativeEvent, (0,
                    i.ensureNotNull)(y.current)) - C.current;
                    a < 0 ? (a = 0,
                    C.current = N(e.nativeEvent, (0,
                    i.ensureNotNull)(y.current))) : a > r * w * S && (a = r * w * S,
                    C.current = N(e.nativeEvent, (0,
                    i.ensureNotNull)(y.current)) - a);
                    d(a / w / S),
                    _(!0)
                }
            }, o.createElement("div", {
                ref: g,
                className: a()(h.bar, m && h["bar--horizontal"]),
                style: {
                    [m ? "minWidth" : "minHeight"]: v,
                    [m ? "width" : "height"]: k,
                    transform: `translate${m ? "X" : "Y"}(${L * w * S || 0}px)`
                },
                onMouseDown: function(e) {
                    e.preventDefault(),
                    C.current = N(e.nativeEvent, (0,
                    i.ensureNotNull)(g.current)),
                    _(!0)
                }
            }, o.createElement("div", {
                className: a()(h.barInner, m && h["barInner--horizontal"])
            })));
            function D(e) {
                const t = N(e, (0,
                i.ensureNotNull)(y.current)) - C.current;
            ...
            function N(e, t) {
                ...
                return m ? e.clientX - n.left : e.clientY - n.top
            }
        }
        var d = n(921258)
          , m = n(982434);
        function h(e) {
            const {reference: t, className: n, containerHeight: a=0, containerWidth: i=0, contentHeight: l=0, contentWidth: s=0, scrollPosTop: u=0, scrollPosLeft: h=0, onVerticalChange: f, onHorizontalChange: p, visible: v} = e
              , [y,g] = (0,
            d.useHover)()
              , [b,_] = (0,
            o.useState)(!1)
            ...
            return o.createElement("div", {
                ...
                style: {
                    visibility: v || y || b ? "visible" : "hidden"
                }
            }, C && o.createElement(c, {
                size: a - E,
                scrollSize: l - E,
    ...
    577687: (e,t,n)=>{
        ...
        function d(e) {
            ...
            return r.createElement(i.Icon, {
                ...m,
                className: a(u.favorite, "apply-common-tooltip", n && u.checked, o && u.active, t),
                icon: n ? l : s,
                onClick: d,
    ...
    512991: (e,t,n)=>{
        ...
        var o = n(372605);
        function r(e) {
            const {data: t, rules: n, queryString: r, isPreventedFromFiltering: a, primaryKey: i, secondaryKey: l=i, optionalPrimaryKey: s, tertiaryKey: u} = e;
            return t.map((e=>{
                ...
                return n.forEach((e=>{
                    ...
                    if (h.lastIndex = 0,
                    (0,
                    o.isString)(t) && t && t.toLowerCase() === r.toLowerCase())
                        return m = 4,
                        void (d = null === (n = t.match(f)) || void 0 === n ? void 0 : n.index);
                    if ((0,
                    o.isString)(t) && f.test(t))
                        return m = 3,
                        void (d = null === (i = t.match(f)) || void 0 === i ? void 0 : i.index);
                    if ((0,
                    o.isString)(a) && f.test(a))
                        return m = 2,
                        void (d = null === (l = a.match(f)) || void 0 === l ? void 0 : l.index);
                    if ((0,
                    o.isString)(a) && h.test(a))
                        return m = 2,
                        void (d = null === (s = a.match(h)) || void 0 === s ? void 0 : s.index);
                    if (Array.isArray(c))
                        for (const e of c)
                            if (f.test(e))
                                return m = 1,
                                void (d = null === (u = e.match(f)) || void 0 === u ? void 0 : u.index)
                }
                )),
                {
                    matchPriority: m,
        ...
        function a(e, t) {
            const n = []
              , o = e.toLowerCase()
              , r = e.split("").map(((e,t)=>`(${0 !== t ? `[/\\s-]${l(e)}` : l(e)})`)).join("(.*?)") + "(.*)";
            return n.push({
        ...
        function i(e, t, n) {
            ...
            return e && n ? (n.forEach((e=>{
                const {fullMatch: n, re: r, reserveRe: a} = e;
                n.lastIndex = 0,
                r.lastIndex = 0;
                const i = n.exec(t)
                  , l = i || r.exec(t) || a && a.exec(t);
                if (e.fuzzyHighlight = !i,
                l)
                    if (e.fuzzyHighlight) {
                        let e = l.index;
    ...
    260598: (e,t,n)=>{
        ...
        function l(e) {
            const {queryString: t, rules: n, text: l, className: s} = e
              , u = (0,
            o.useMemo)((()=>(0,
            a.getHighlightedChars)(t, l, n)), [t, n, l]);
            return o.createElement(o.Fragment, null, u.length ? l.split("").map(((e,t)=>o.createElement(o.Fragment, {
                key: t
            }, u[t] ? o.createElement("span", {
                className: r(i.highlighted, s)
            }, e) : o.createElement("span", null, e)))) : l)
        }
    }
    ,
    330344: (e,t,n)=>{
        ...
        function s(e, t=i.CheckMobile.any()) {
            ...
            o.useState)({
                ...
                onVerticalChange: function(e) {
                    ...
                    (0,
                    r.ensureNotNull)(s.current).scrollTop = e
                },
                onHorizontalChange: function(e) {
                    ...
                    (0,
                    r.ensureNotNull)(s.current).scrollLeft = e
                },
                visible: u
            })
              , h = (0,
            o.useCallback)((()=>{
                if (!s.current)
                    return;
                const {clientHeight: e, scrollHeight: t, scrollTop: o, clientWidth: r, scrollWidth: a, scrollLeft: i} = s.current
            ...
            function f() {
                m((e=>({
                    ...e,
                    scrollPosTop: (0,
                    r.ensureNotNull)(s.current).scrollTop,
                    scrollPosLeft: (0,
                    r.ensureNotNull)(s.current).scrollLeft
                })))
            }
            return (0,
            o.useEffect)((()=>{
    ...
    192063: (e,t,n)=>{
        ...
        function d(e) {
            const {id: t, role: n, "aria-label": u, "aria-selected": d, "aria-checked": m, className: h, title: f, labelRowClassName: p, labelClassName: v, shortcut: y, forceShowShortcuts: g, icon: b, isActive: _, isDisabled: C, isHovered: w, appearAsDisabled: E, label: k, link: S, showToolboxOnHover: L, showToolboxOnFocus: D, target: x, rel: N, toolbox: A, reference: M, onMouseOut: z, onMouseOver: R, onKeyDown: T, suppressToolboxClick: F=!0, theme: I=s, tabIndex: B, tagName: P, renderComponent: O, roundedIcon: j, iconAriaProps: Z} = e
              , H = (0,
            l.filterDataProps)(e)
              , W = (0,
            o.useRef)(null)
            ...
            o.useMemo)((()=>function(e) {
                function t(t) {
                    const {reference: n, ...r} = t
                      ...
                      , i = "a" === a ? r : function(e) {
                        const {download: t, href: n, hrefLang: o, media: r, ping: a, rel: i, target: l, type: s, referrerPolicy: u, ...c} = e;
                        return c
                    }(r);
            ...
            return o.createElement(q, {
                ...
                "aria-selected": d,
                "aria-checked": m,
                className: r(h, I.item, b && I.withIcon, {
                    [I.isActive]: _,
                    [I.isDisabled]: C || E,
                    [I.hovered]: w
                }),
                ...
                onClick: function(t) {
                    const {dontClosePopup: n, onClick: o, onClickArg: r, trackEventObject: l} = e;
                    if (C)
                        return;
                    l && (0,
                    i.trackEvent)(l.category, l.event, l.label);
                    o && o(r, t);
                    n || (0,
                    a.globalCloseMenu)()
                },
                onContextMenu: function(t) {
                    ...
                    n && o && (0,
                    i.trackEvent)(n.category, n.event, `${n.label}_rightClick`)
                },
                onMouseUp: function(t) {
                    ...
                    if (1 === t.button && S && n) {
                        ...
                        (0,
                        i.trackEvent)(n.category, n.event, e)
                    }
                },
                onMouseOver: R,
                onMouseOut: z,
                onKeyDown: T,
                tabIndex: B
            }, void 0 !== b && o.createElement("span", {
                "aria-label": Z && Z["aria-label"],
                "aria-hidden": Z && Boolean(Z["aria-hidden"]),
                className: r(I.icon, j && s["round-icon"]),
                dangerouslySetInnerHTML: {
                    __html: b
                }
            }), o.createElement("span", {
                className: r(I.labelRow, p)
            }, o.createElement("span", {
                className: r(I.label, v)
            }, k)), (void 0 !== y || g) && o.createElement("span", {
                className: I.shortcut
            }, (Y = y) && Y.split("+").join(" + ")), void 0 !== A && o.createElement("span", {
                onClick: F ? c : void 0,
                className: r(I.toolbox, {
                    [I.showOnHover]: L,
                    [I.showOnFocus]: D
                })
            }, A));
    ...
    624216: (e,t,n)=>{
        ...
        function m(e) {
            const {controller: t, children: n, isOpened: m, closeOnClickOutside: h=!0, doNotCloseOn: f, onClickOutside: p, onClose: v, onKeyboardClose: y, "data-name": g="popup-menu-container", ...b} = e
              , _ = (0,
            o.useContext)(s.CloseDelegateContext)
              , C = o.useContext(d)
              , w = (0,
            o.useContext)(u)
              , E = (0,
            ...
            return m ? o.createElement(i.Portal, {
                top: "0",
                left: "0",
                right: "0",
                bottom: "0",
    ...
    72621: (e,t,n)=>{
        ...
        var o = n(509806)
          ...
          , s = n(927306);
        function u(e) {
            const {className: t, isActive: u, onClick: c, onMouseDown: d, title: m, hidden: h, "data-name": f="remove-button", ...p} = e;
            return r.createElement(i.Icon, {
                ...p,
                "data-name": f,
                className: a(s.button, "apply-common-tooltip", u && s.active, h && s.hidden, t),
                icon: l,
                onClick: c,
                onMouseDown: d,
    ...
    695257: (e,t)=>{
        ...
        function N(e, t, r, a, i) {
            ...
            if (s)
                ...
                }(i, r + (!i.key || s && s.key === i.key ? "" : ("" + i.key).replace(D, "$&/") + "/") + e)),
                t.push(i)),
                1;
            if (s = 0,
            a = "" === a ? "." : a + ":",
        ...
        t.cloneElement = function(e, t, o) {
            ...
            if (null != t) {
                ...
                for (u in t)
                    w.call(t, u) && !k.hasOwnProperty(u) && (r[u] = void 0 === t[u] && void 0 !== s ? s[u] : t[u])
            }
    ...
    208955: (e,t,n)=>{
        ...
        var o = n(50959)
          ...
          , y = n(633476);
        function g(e) {
            const {sortDirection: t, children: n, ...r} = e
              , i = (0,
            o.useRef)(null)
              , [l,s] = (0,
            o.useState)(!1);
            return o.createElement("div", {
                ...r,
                ref: i,
                className: a(y.sortButton, "apply-common-tooltip", "common-tooltip-vertical"),
                onClick: function() {
                    s(!l)
                }
                ...
                ,
                position: (0,
                h.getPopupPositioner)(i.current, {
                    verticalMargin: -35,
        ...
        var b = n(192063)
          , _ = n(464409);
        function C(e) {
            const {label: t, listSortField: n, itemSortField: r, listSortDirection: i, itemSortDirection: l, onClick: s, className: u, ...c} = e
              , d = r === n && l === i;
            return o.createElement(b.PopupMenuItem, {
                ...c,
                className: a(_.container, u),
        ...
        var M = n(73288)
          , z = n(846188);
        function R(e) {
            const {className: t, onScroll: n, onTouchStart: r, reference: a, children: l, scrollbar: s, ...u} = e
              , [d,m] = (0,
            N.useDimensions)()
              , [h,f,p,v] = (0,
            A.useOverlayScroll)();
            ...
            o.useEffect)((()=>{
                const e = ()=>{}
                ;
                return c.isFF ? (document.addEventListener("wheel", (()=>e)),
                ()=>{
        ...
        var j = n(906355)
          ...
          , W = n(512991)
          , K = n(629276);
        const q = new j.DateFormatter("dd-MM-yyyy")
          , Y = new Z.TimeFormatter(Z.hourMinuteFormat)
          , V = F.enabled("items_favoriting");
        function $(e) {
            const {chart: t, chartWidgetCollection: r, trackEvent: a, localFavorites: l, setLocalFavorites: u, onClose: c, searchString: d, onClickRemove: m, onRemoveCanceled: h, isSelected: f} = e
              , [p,v] = (0,
            o.useState)((()=>t.active()))
              , [y,g] = (0,
            o.useState)(!1)
              , b = t.url ? function(e) {
                ...
                return e.symbol && n.searchParams.append("symbol", e.symbol),
                e.interval && n.searchParams.append("interval", e.interval),
                e.style && n.searchParams.append("style", e.style),
                (0,
                T.urlWithMobileAppParams)(n.href)
            }({
                chartId: t.url
            }) : void 0
              , _ = (0,
            o.useContext)(P.SlotContext)
              , C = (0,
            o.useMemo)((()=>new Date(1e3 * t.modified)), [t])
              , w = (0,
            o.useMemo)((()=>(0,
            W.createRegExpList)(d)), [d])
              , E = i()(K.highlight, p && K.active);
            return (0,
            o.useEffect)((()=>(r && r.metaInfo.id.subscribe(S),
            ()=>{
                r && r.metaInfo.id.unsubscribe(S)
            }
            )), []),
            o.createElement(I.DialogContentItem, {
                url: b,
                title: o.createElement(H.HighlightedText, {
                    className: E,
                    queryString: d,
                    rules: w,
                    text: t.title
                }),
                subtitle: o.createElement(o.Fragment, null, o.createElement(H.HighlightedText, {
                    className: E,
                    queryString: d,
                    rules: w,
                    text: t.description
                }), " ", "(", q.format(C).replace(/-/g, "."), " ", Y.formatLocal(C), ")"),
                onClick: function(e) {
                    0;
                    t.openAction(),
                    !1
            ...
            o.forwardRef)((({style: e, ...r},a)=>{
                ...
                return o.createElement("div", {
                    ...
                    style: {
                        ...e,
                        height: `${((0,
                        L.isNumber)(i) ? i : parseFloat(i)) + t + n}px`
                    },
                    ...r
                })
            }
        ...
        function oe(e) {
            const {charts: t, onClose: r, favoriteChartsService: a, chartWidgetCollection: m} = e
              , [h,f] = (0,
            o.useState)("")
              , [p,v] = (0,
            o.useState)(h)
            ...
            o.useState)((function() {
                if (a)
                    return a.get();
                const e = {};
                return t.filter((e=>e.favorite)).forEach((t=>{
                    e[t.id] = !0
                }
                )),
                e
              ...
              , [D,x] = (0,
            o.useState)((()=>u.getJSON("loadChartDialog.viewState", G)))
              , N = (0,
            o.useRef)(null)
              , A = (0,
            o.useRef)(null)
            ...
            o.useEffect)((()=>{
                c.CheckMobile.any() || (0,
                l.ensureNotNull)(N.current).focus()
            }
            ), []);
            const z = (0,
            o.useRef)();
            (0,
            o.useEffect)((()=>(z.current = setTimeout((()=>{
                f(p)
            }
            ), 300),
            ()=>{
            ...
            (0,
            o.useEffect)((()=>(null == a || a.getOnChange().subscribe(null, K),
            ()=>{
                null == a || a.getOnChange().unsubscribe(null, K)
            }
            )), []);
            const T = (0,
            o.useCallback)((()=>!0), [])
            ...
            o.useMemo)((()=>{
                return (0,
                W.rankedSearch)({
                    data: M.filter((e=>!y.includes(e.id))).sort((e = D.sortDirection,
                    (t,n)=>{
                        if (E[t.id] && !E[n.id])
                            return -1;
                        if (!E[t.id] && E[n.id])
                            return 1;
                        const o = 0 === e ? 1 : -1;
                        return "modified" === D.sortField ? o * (t.modified - n.modified) : o * t.title.localeCompare(n.title)
                    }
                    )),
                    rules: (0,
                    W.createRegExpList)(h),
                    queryString: h,
                    primaryKey: "title",
              ...
              , {selectedItemIndex: I, setSelectedItemIndex: B, handleKeyboardSelection: P} = function(e, t, n) {
                const [r,a] = (0,
                o.useState)(-1);
                return (0,
                o.useEffect)((()=>{
                    var e;
                    -1 !== r && (null === (e = n.current) || void 0 === e || e.scrollToItem(r))
                }
                ), [r]),
                {
                    selectedItemIndex: r,
            ...
            return o.createElement(d.AdaptivePopupDialog, {
                ...
                render: function() {
                    return o.createElement(o.Fragment, null, o.createElement(w.DialogSearch, {
                        reference: N,
                        onChange: j,
                        placeholder: s.t(null, void 0, n(252298))
                    }), o.createElement(k, {
                        className: i()(!te && J.contentHeader)
                    }, o.createElement(S, {
                        title: s.t(null, void 0, n(425653))
                    }), o.createElement(g, {
                        ...
                        itemCount: F.length,
                        itemSize: 52,
                        className: J.contentList,
                        onScroll: O,
                        innerElementType: X,
                        itemKey: e=>(E[F[e].id] ? "f_" : "") + F[e].id,
                        children: ({style: e, index: t})=>o.createElement("div", {
                            style: e
                        }, o.createElement($, {
                            chart: F[t],
                            onClose: r,
            ...
            function q() {
                (0,
                l.ensureNotNull)(_.current).focus()
            }
            function Y(e, t) {
                const n = {
                    sortField: e,
        ...
        var re = n(19406);
        class ae extends re.DialogRenderer {
            constructor(e) {
                super(),
                this._options = e
            }
            show() {
                r.render(o.createElement(oe, {
                    ...this._options,
                    onClose: ()=>this.hide()
                }), this._container),
