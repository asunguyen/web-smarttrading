(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[607], {
    487816: (e,t,i)=>{
        ...
        i.r(t),
        i.d(t, {
            RegressionTrendDefinitionsViewModel: ()=>T
        });
        var n = i(509806)
          , a = i(664902)
          , l = (i(336379),
        i(620004))
          ...
          , s = i(311757)
          , o = i(410890);
        const d = new a.TranslatedString("change {title} base line visibility",n.t(null, void 0, i(616688)))
          ...
          , p = new a.TranslatedString("change {title} up line visibility",n.t(null, void 0, i(117564)))
        ...
        class T extends r.StudyLineDataSourceDefinitionsViewModel {
            ...
            _stylePropertyDefinitions() {
                ...
                s.removeSpaces)(t)
                  ...
                  , r = e.baseLine.childs()
                  , T = (0,
                l.createLinePropertyDefinition)({
                    checked: (0,
                    l.convertToDefinitionProperty)(this._propertyApplier, new o.StudyPlotVisibleProperty(r.display), d.format({
                        title: n
                    })),
                    color: (0,
                    l.getColorDefinitionProperty)(this._propertyApplier, r.color, e.transparency, c.format({
                        title: n
                    })),
                    width: (0,
                    l.convertToDefinitionProperty)(this._propertyApplier, r.linewidth, h.format({
                        title: n
                    })),
                    style: (0,
                    l.convertToDefinitionProperty)(this._propertyApplier, r.linestyle, u.format({
                        title: n
                    }))
                }, {
                    id: `${i}BaseLine`,
                ...
                l.createLinePropertyDefinition)({
                    checked: (0,
                    l.convertToDefinitionProperty)(this._propertyApplier, new o.StudyPlotVisibleProperty(L.display), p.format({
                        title: n
                    })),
                    color: (0,
                    l.getColorDefinitionProperty)(this._propertyApplier, L.color, e.transparency, y.format({
                        title: n
                    })),
                    width: (0,
                    l.convertToDefinitionProperty)(this._propertyApplier, L.linewidth, g.format({
                        title: n
                    })),
                    style: (0,
                    l.convertToDefinitionProperty)(this._propertyApplier, L.linestyle, b.format({
                        title: n
                    }))
                }, {
                    id: `${i}UpLine`,
                ...
                return {
                    ...
                    l.createLinePropertyDefinition)({
                        checked: (0,
                        l.convertToDefinitionProperty)(this._propertyApplier, new o.StudyPlotVisibleProperty(M.display), _.format({
                            title: n
                        })),
                        color: (0,
                        l.getColorDefinitionProperty)(this._propertyApplier, M.color, e.transparency, m.format({
                            title: n
                        })),
                        width: (0,
                        l.convertToDefinitionProperty)(this._propertyApplier, M.linewidth, v.format({
                            title: n
                        })),
                        style: (0,
                        l.convertToDefinitionProperty)(this._propertyApplier, M.linestyle, f.format({
                            title: n
                        }))
                    }, {
                        id: `${i}DownLine`,
                    ...
                    l.createCheckablePropertyDefinition)({
                        checked: (0,
                        l.convertToDefinitionProperty)(this._propertyApplier, e.extendLines, w.format({
                            title: n
                        }))
                    }, {
                        id: `${i}ExtendLines`,
                    ...
                    l.createCheckablePropertyDefinition)({
                        checked: (0,
                        l.convertToDefinitionProperty)(this._propertyApplier, e.showPearsons, k.format({
                            title: n
                        }))
                    }, {
                        id: `${i}Pearsons`,
    ...
    746418: (e,t,i)=>{
        ...
        i.r(t),
        i.d(t, {
            StudyOverlayDefinitionsViewModel: ()=>O
        });
        var n = i(509806)
          , a = i(664902)
          , l = i(156963)
        ...
        i(620004))
          ...
          , h = i.n(c)
          , u = i(311757);
        const p = new a.TranslatedString("change {inputName} property",n.t(null, void 0, i(621547)));
        function y(e, t) {
            const i = e.id;
        ...
        function g(e) {
            return e.name || (0,
            u.capitalizeFirstLetterInWord)(e.id.toLowerCase())
        }
        function b(e) {
            return n.t(e, {
                context: "input"
        ...
        const w = n.t(null, void 0, i(832733))
          ...
          , P = ["1", "3", "5", "15", "30", "45", "60", "120", "180", "240", "1D", "1W", "1M"].map((e=>({
            value: e,
            title: (0,
            v.getTranslatedResolutionModel)(e).hint
        })));
        var z = i(738597)
          , I = i(681434);
        const D = new a.TranslatedString("change study overlay style",n.t(null, void 0, i(705529)))
          ...
          , A = n.t(null, void 0, i(542097))
          , U = n.t(null, void 0, i(134911))
          , E = n.t(null, void 0, i(117712))
          , W = n.t(null, void 0, i(631994))
          , C = n.t(null, void 0, i(938397))
          , B = n.t(null, void 0, i(79511))
          , H = n.t(null, void 0, i(832733))
          , R = n.t(null, void 0, i(491492))
          , X = n.t(null, void 0, i(836993))
          , V = [{
            title: N,
            value: 0
        }, {
        ...
        l.enabled("chart_style_hilo") && V.push({
            title: W,
            value: 12
        });
        class O extends class {
            constructor(e, t) {
                ...
                null !== this._inputSourceItems && this._undoModel.model().dataSourceCollectionChanged().subscribe(this, (()=>{
            ...
            destroy() {
                ...
                this._propertyPages.forEach((e=>{
                    (0,
                    s.destroyDefinitions)(e.definitions.value())
                }
                ))
            }
            propertyPages() {
            ...
            _createStylePropertyPage() {
                ...
                return null !== e ? (0,
                o.createPropertyPage)(e, "style", w) : null
            }
            _createVisibilitiesPropertyPage() {
                const e = this._source.properties().childs().intervalsVisibilities.childs();
                return (0,
                o.createPropertyPage)((0,
                f.getIntervalsVisibilitiesPropertiesDefinitions)(this._undoModel, e, new a.TranslatedString(this._source.name(!0),this._source.title(!0))), "visibility", S)
            }
            _stylePropertyDefinitions() {
                return null
            }
            _createInputsPropertyPage() {
                ...
                return null !== e ? (0,
                o.createPropertyPage)(e, "inputs", k) : null
            }
            _inputsPropertyDefinitions() {
                ...
                return null !== this._sourceInput && (this._inputSourceItems = new (h())(this._getInputSourceItems())),
                function(e, t, l, o, d) {
                    const c = [];
                    for (const u of t) {
                        if (!y(u, o))
                        ...
                        if ("resolution" === u.type)
                            ...
                            s.createOptionsPropertyDefinition)({
                                option: (0,
                                s.convertToDefinitionProperty)(e, l[u.id], p.format({
                                    inputName: v
                                }))
                            }, {
                                id: _,
                                title: m,
                                options: new (h())(d.resolutionItems)
                            });
                        else if ("source" === u.type) {
                            const t = (0,
                            r.ensure)(d.sourcesItems);
                            f = (0,
                            s.createOptionsPropertyDefinition)({
                                option: (0,
                                s.convertToDefinitionProperty)(e, l[u.id], p.format({
                            ...
                            for (const e of u.options) {
                                const a = u.optionsTitles && u.optionsTitles[e] || e
                                  , l = n.t(a, {
                                    context: "input"
                                }, i(788601));
                                t.push({
                            ...
                            const t = l[u.id]
                              , i = (0,
                            r.ensure)(d.getSymbolInfoBySymbol)
                              , n = (0,
                            r.ensure)(d.onSymbolsInfosChanged);
                            f = (0,
                            s.createSymbolPropertyDefinition)({
                                symbol: (0,
                                s.getSymbolDefinitionProperty)(e, t, i, n, p.format({
                                    inputName: v
                            ...
                            f = (0,
                            s.createSessionPropertyDefinition)({
                                session: (0,
                                s.convertToDefinitionProperty)(e, l[u.id], p.format({
                                    inputName: v
                                }))
                            ...
                            void 0 !== u.min && (t.min = new (h())(u.min)),
                            void 0 !== u.max && (t.max = new (h())(u.max)),
                            void 0 !== u.step && isFinite(u.step) && u.step > 0 && (t.step = new (h())(u.step)),
                            f = (0,
                            s.createNumberPropertyDefinition)({
                                value: (0,
                                s.convertToDefinitionProperty)(e, l[u.id], p.format({
                                    inputName: v
                                }))
                            ...
                            f = (0,
                            s.createTextPropertyDefinition)({
                                text: (0,
                                s.convertToDefinitionProperty)(e, l[u.id], p.format({
                                    inputName: v
                                }))
            ...
            _getInputSourceItems() {
                const e = _.basePriceSources.slice()
                  , t = (0,
                r.ensureNotNull)(this._sourceInput);
                if (this._source && this._source.isChildStudy()) {
                    const i = this._source.inputs()[t.id]
                      , n = (0,
                    r.ensureNotNull)(this._source.parentSourceForInput(i.v))
                      , a = n.title()
                      , l = m.StudyMetaInfo.getChildSourceInputTitles(t, n.metaInfo(), a);
                ...
                if (l.enabled("study_on_study") && this._source && (this._source.isChildStudy() || m.StudyMetaInfo.canBeChild(this._source.metaInfo()))) {
        ...
        }
        {
            constructor(e, t) {
                ...
                this._source.properties().childs().style.subscribe(this, (e=>{
                    var t;
                    null !== this._stylesPropertyPage && ((0,
                    s.destroyDefinitions)(this._stylesPropertyPage.definitions.value()),
            ...
            _stylePropertyDefinitions() {
                void 0 === this._availableStylesWV && (this._availableStylesWV = new (h())(this._availableStyles()),
                ...
                s.createOptionsPropertyDefinition)({
                    option: (0,
                    s.convertToDefinitionProperty)(this._undoModel, e.style, D)
                }, {
                ...
                s.createCheckablePropertyDefinition)({
                    checked: (0,
                    s.convertToDefinitionProperty)(this._undoModel, e.showPriceLine, T)
                }, {
                ...
                s.createOptionsPropertyDefinition)({
                    option: (0,
                    s.convertToDefinitionProperty)(this._undoModel, e.minTick, L)
                }, {
                    id: "StudyOverlayMinTick",
                    title: X,
                    options: new (h())((0,
                    _.seriesPrecisionValues)())
                })
                  , a = (0,
                u.removeSpaces)(this._source.title());
                return {
                    definitions: [(0,
                    s.createPropertyDefinitionsGeneralGroup)([t, ...this._getSeriesStylesDefinitions()], `SeriesStyleGroup ${a}`), i, n]
                }
            }
            _getSeriesStylesDefinitions() {
                const e = this._source.properties().childs()
                  , t = e.style.value();
                return (0,
                z.getSeriesStylePropertiesDefinitions)(this._undoModel, e, t, {
            ...
            _availableStyles() {
                ...
                return V.map((t=>t.readonly ? t : {
                    readonly: !1,
                    value: t.value,
                    title: t.title,
                    disabled: (0,
                    I.isCloseBasedSymbol)(e) && !(0,
                    I.isSingleValueBasedStyle)(t.value)
                }))
            }
        }
    }
