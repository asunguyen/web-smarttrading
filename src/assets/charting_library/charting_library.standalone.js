var TradingView = function(t) {
    ...
    let o = !1;
    function s() {
        return "TT v25.000 (internal id 1394882f @ 2023-05-22T15:09:18.744Z)"
    }
    const r = class {
        constructor(t) {
            var i;
            ...
            (null === (i = t.overrides) || void 0 === i ? void 0 : i["mainSeriesProperties.priceAxisProperties.lockScale"]) && (console.warn("mainSeriesProperties.priceAxisProperties.lockScale can not be set to true within the widget constructor"),
            ...
            console.log("Using TT v25.000 (internal id 1394882f @ 2023-05-22T15:09:18.744Z)"))),
            this._create()
        }
        setDebugMode(t) {
        ...
        _create() {
            ...
            n && (a.contentWindow ? (a.contentWindow.document.open(),
            a.contentWindow.document.write(o),
            a.contentWindow.document.close()) : console.warn("Unable to locate contentWindow for the created iframe. Please try disabling the `iframe_loading_compatibility_mode` featureset.")),
        ...
        _render(t) {
            ...
            this._options.locale) {
                ...
                i.findIndex((e=>e.language === t)) >= 0 || (console.warn("locale isn't supported. Using default of `en`."),
                this._options.locale = "en")
            }
            const n = function(t, e) {
                var n;
                const o = new URL(`${t || ""}`,location.href).href
                  , s = JSON.parse('["bundles/runtime.07ec92a07353c2909892.js","bundles/__LANG__.4421.9dbb00f178cf991a2648.js","bundles/6714.8144d673b80cea5bd5d7.css","bundles/6714.8144d673b80cea5bd5d7.rtl.css","bundles/6412.a95132e088bf92f9884f.js","chobot.js","bundles/library.0b92f0ef2a7b26accc19.js"]')
                  ...
                  , l = `\n ${function(t, e, n) {
                    ...
                    const i = []
                      ...
                      , r = /\.rtl\.css$/i;
                    for (const a of t)
                        a.endsWith(".js") ? i.push(`<script defer crossorigin="anonymous" src="${a.replace("__LANG__", n)}"><\/script>`) : s.test(a) && e === r.test(a) && o.push(`<link type="text/css" href="${a}" rel="stylesheet"/>`);
                    return [...i, ...o].join("\n")
                }(s, "rtl" === a.dir, r)}\n`;
                return `<!DOCTYPE html>
                <html ${(h = {
