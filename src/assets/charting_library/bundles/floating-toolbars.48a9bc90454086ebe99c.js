(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[2306], {
    ...
    805184: (t,e,o)=>{
        ...
        function c(t) {
            return i.createElement(n.SquareButton, {
                ...l(t)
            })
        }
    }
    ...
    171529: (t,e,o)=>{
        ...
        var i = o(50959)
          ...
          , l = o.n(a);
        function c(t) {
            const {color: e="brand", size: o="medium", variant: i="primary", stretch: s=!1, icon: a, startIcon: c, endIcon: d, iconOnly: h=!1, className: p, isGrouped: u, cellState: m, disablePositionAdjustment: g=!1, primaryText: _, secondaryText: v, isAnchor: f=!1} = t
              , y = function(t) {
                let e = "";
                return 0 !== t && (1 & t && (e = n(e, l()["no-corner-top-left"])),
                2 & t && (e = n(e, l()["no-corner-top-right"])),
                4 & t && (e = n(e, l()["no-corner-bottom-right"])),
                8 & t && (e = n(e, l()["no-corner-bottom-left"]))),
                e
            }((0,
            r.getGroupCellRemoveRoundBorders)(m));
            return n(p, l().button, l()[`size-${o}`], l()[`color-${e}`], l()[`variant-${i}`], s && l().stretch, (a || c) && l()["with-start-icon"], d && l()["with-end-icon"], h && l()["icon-only"], y, u && l().grouped, u && !g && l()["adjust-position"], u && m.isTop && l()["first-row"], u && m.isLeft && l()["first-col"], _ && v && l()["multiline-content"], f && l().link)
        }
        function d(t) {
        ...
        var h = o(380327)
          , p = o(800417);
        function u(t) {
            const {className: e, color: o, variant: i, size: n, stretch: r, animated: s, icon: a, iconOnly: l, startIcon: c, endIcon: d, primaryText: h, secondaryText: u, ...m} = t;
            return {
                ...m,
                ...(0,
                p.filterDataProps)(t),
        ...
        function m(t) {
            const {reference: e, ...o} = t
              , {isGrouped: n, cellState: r, disablePositionAdjustment: s} = (0,
    ...
    496818: (t,e,o)=>{
            ...
            constructor(t) {
                ...
                this._handleDragMove = t=>{
                    ...
                    if (null !== this._helper.containment) {
                        ...
                        a && this._helper.nextTop && (this._helper.nextTop = Math.min(this._helper.nextTop, i),
                    ...
                    null !== this._helper.raf || r === this._helper.nextTop && s === this._helper.nextLeft || (this._helper.raf = requestAnimationFrame((()=>{
                        null !== this._helper && (null !== this._helper.nextTop && (n.style.top = this._helper.nextTop + "px",
                        this._helper.nextTop = null),
                        null !== this._helper.nextLeft && (n.style.left = this._helper.nextLeft + "px",
        ...
        class l {
            constructor(t) {
                ...
                this._handlePointerDown = t=>{
                    if (null !== this._initial)
                        return;
                    if (!(t.target instanceof Element && this._handle.contains(t.target)))
                        return;
                    if (this._initial = t,
                ...
                this._handlePointerMove = t=>{
                    null !== this._initial && this._initial.pointerId === t.pointerId && (t.preventDefault(),
            ...
            destroy() {
                ...
                null !== this._initial && (t.releasePointerCapture(this._initial.pointerId),
                this._initial = null)
            }
            _getEventTarget() {
                return r.CheckMobile.iOS() || (0,
                r.isMac)() && s.touch ? window.document.documentElement : this._handle
            }
            _dispatchEvent(t) {
                switch (t.type) {
    ...
    821205: (t,e,o)=>{
        ...
        var i = o(650151)
          , n = o(65160);
        function r(t, e) {
            return void 0 === e || (null === e && (t.innerHTML = ""),
        ...
        function a(t) {
            ...
            if ("fixed" === e.position)
                ...
                for (; n && (n === e.body || n === e.documentElement) && "static" === getComputedStyle(n).position; )
                    n = n.parentElement;
                n && n !== t && 1 === n.nodeType && (i = s(n),
    ...
    523847: (t,e,o)=>{
        ...
        var i = o(50959)
          ...
          , _ = o(312005);
        function v(t) {
            const {property: e, icon: o, propertyApplier: n, title: v, undoText: f, isToolbarFixed: y, className: w} = t
              , b = (0,
            m.useProperty)(e)
              , C = (0,
            i.useRef)(null)
              , T = b ? (0,
            l.parseRgba)(b)[3] : void 0
              , E = "" === b
            ...
            return i.createElement(u.ToolWidgetMenu, {
                ...
                onColorChange: function(t, e) {
                    const o = b ? (0,
                    c.alphaToTransparency)((0,
                    l.parseRgba)(b)[3]) : 0;
                    D((0,
                    c.generateColor)(String(t), o, true)),
                    e || (0,
                    s.ensureNotNull)(C.current).close()
                },
                onOpacityChange: function(t) {
                    D((0,
                    c.generateColor)(b, (0,
                    c.alphaToTransparency)(t), !0))
                },
    ...
    822598: (t,e,o)=>{
        ...
        var i = o(50959)
          ...
          , v = o(820835);
        const f = (0,
        d.mergeThemes)(c.DEFAULT_POPUP_MENU_ITEM_THEME, v)
          , y = [{
            value: 1,
            icon: p
        }, {
        ...
        function w(t) {
            const {multipleProperty: e, title: o, undoText: d, propertyApplier: p, isToolbarFixed: u, className: m, isSmallScreen: g} = t
              , w = (0,
            l.useProperty)((0,
            r.ensureDefined)(e))
              , b = "mixed" === w || !w
            ...
            return i.createElement(a.ToolWidgetMenu, {
                ...
                content: i.createElement("div", null, b ? i.createElement("div", {
                    className: v.multiWidth
                }, i.createElement(s.Icon, {
                    icon: _
                })) : i.createElement("div", {
                    className: v.buttonWrap
                }, !g && i.createElement(s.Icon, {
                    icon: C
                }), i.createElement("div", {
                    className: n(!g && v.buttonLabel)
                }, `${w}px`)))
            }, y.map((({value: t, icon: e})=>i.createElement(c.PopupMenuItem, {
                key: t,
                theme: f,
                label: `${t}px`,
                icon: e,
    ...
    557630: (t,e,o)=>{
        ...
        function _(t) {
            ...
            return i.createElement(i.Fragment, null, i.createElement("div", {
                ...
                className: n(g.swatch, v && g.hover, a && g.selected, !r && g.empty, String(r).toLowerCase() === u.white && g.white),
                onClick: function() {
                    _(r)
                },
                onContextMenu: b ? C : void 0
            }), b && i.createElement(d.PopupMenu, {
                isOpened: v,
                onClose: C,
                position: function() {
                    const t = (0,
                    l.ensureNotNull)(w.current).getBoundingClientRect();
                    return {
                        x: t.left,
                        y: t.top + t.height + 4
                    }
        ...
        class T extends i.PureComponent {
            constructor() {
                ...
                this._handlePosition = t=>{
                    const {hsv: {h: e}, onChange: o} = this.props;
                    if (!o)
                        return;
                    const i = (0,
                    l.ensureNotNull)(this._container).getBoundingClientRect()
                      , n = t.clientX - i.left
                      , r = t.clientY - i.top;
                    let s = n / i.width;
                    s < 0 ? s = 0 : s > 1 && (s = 1);
                ...
                ,
                this._mouseMove = (0,
                b.default)(this._handlePosition, 100),
                this._handleTouch = t=>{
                    this._handlePosition(t.nativeEvent.touches[0])
                }
            }
            render() {
                const {className: t, hsv: {h: e, s: o, v: n}} = this.props
                  , s = `hsl(${360 * e}, 100%, 50%)`;
                return i.createElement("div", {
        ...
        class S extends i.PureComponent {
            constructor() {
                ...
                ,
                this._handlePosition = t=>{
                    const {hsv: {s: e, v: o}, onChange: i} = this.props;
                    if (!i)
                        return;
                    const n = (0,
                    l.ensureNotNull)(this._container).getBoundingClientRect();
            ...
            render() {
                const {className: t, hsv: {h: e}} = this.props;
                return i.createElement("div", {
                    className: r()(E.hue, t)
                }, i.createElement("div", {
        ...
        class N extends i.PureComponent {
            ...
            render() {
                const {color: t, opacity: e, selectCustom: o, selectOpacity: n, customColors: s, onRemoveCustomColor: a} = this.props
    ...
    939075: (t,e,o)=>{
        ...
        class l extends i.PureComponent {
            constructor(t) {
                ...
                this._handlePosition = t=>{
                    null === this._raf && (this._raf = requestAnimationFrame((()=>{
                        const e = (0,
                        r.ensureNotNull)(this._container)
                          , o = (0,
                        r.ensureNotNull)(this._pointer)
                          , i = e.getBoundingClientRect()
                          , n = o.offsetWidth
                          , a = t.clientX - n / 2 - i.left
                          , l = (0,
                        s.clamp)(a / (i.width - n), 0, 1);
                        this.setState({
            ...
            _dragSubscribe() {
                const t = (0,
                r.ensureNotNull)(this._container).ownerDocument;
                t && (t.addEventListener("mouseup", this._mouseUp),
                t.addEventListener("mousemove", this._mouseMove))
            }
            _dragUnsubscribe() {
                const t = (0,
                r.ensureNotNull)(this._container).ownerDocument;
                t && (t.removeEventListener("mousemove", this._mouseMove),
    ...
    206397: (t,e,o)=>{
        ...
        function s(t, e) {
            (0,
            i.useEffect)((()=>(r.subscribe(t, e, null),
            ()=>{
        ...
        function l() {
            ...
            i.useCallback)((e=>{
                const o = e ? (0,
                a.parseRgb)(e) : null;
                t.some((t=>null !== t && null !== o && (0,
                a.areEqualRgb)((0,
                a.parseRgb)(t), o))) || (r.emit("add_new_custom_color", e),
                (0,
                n.setJSON)("pickerCustomColors", c(e, t)))
            }
            ), [t])
              , l = (0,
            i.useCallback)((e=>{
                (e >= 0 || e < t.length) && (r.emit("remove_custom_color", e),
                (0,
                n.setJSON)("pickerCustomColors", d(e, t)))
            }
            ), [t]);
            return [t, o, l]
        }
    ...
    313739: (t,e,o)=>{
        ...
        function l(t, e) {
            const o = {};
            for (const i in t)
                t.hasOwnProperty(i) && (o[i] = e(i, t[i]));
            return o
        }
    }
    ,
    ...
    800756: (t,e,o)=>{
        ...
        class _ extends n.FloatingToolbar {
            ...
            show() {
                this._canBeShownValue.value() && (this.isVisible() || this._renderAllLinetools(),
                super.show())
            }
            showAndSaveSettingsValue() {
                this._canBeShownValue.value() && (u.TVLocalStorage.setItem("ChartFavoriteDrawingToolbarWidget.visible", "true"),
                this.show())
            }
            ...
            _onFavoriteAdded(t) {
                ...
                r.LinetoolsFavoritesStore.favorites().filter(v).length > 0 && (this._canBeShownValue.setValue(!0),
            ...
            _onFavoriteRemoved(t) {
                ...
                0 === r.LinetoolsFavoritesStore.favorites().filter(v).length && (this._canBeShownValue.setValue(!1),
                this.hide())
            }
            _onFavoriteMoved() {
            ...
            _createLinetoolWidget(t) {
                const e = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${t === d.tool.value() ? "i-active" : ""}" title="${h.lineToolsInfo[t].localizedName}" data-name="FavoriteToolbar ${t}">${h.lineToolsInfo[t].icon}</span>`
                  , o = (0,
                a.parseHtmlElement)(e);
                return o.addEventListener("click", (async e=>{
                    e.preventDefault(),
                    await (0,
                    g.initLineTool)(t),
            ...
            _renderAllLinetools() {
                this._linetoolsWidgets = {},
                this.removeWidgets(),
                r.LinetoolsFavoritesStore.favorites().filter((t=>h.lineToolsInfo[t] && !0)).forEach((t=>{
                    this.addWidget(this._createLinetoolWidget(t))
                }
                ))
            }
            _attachHandlers() {
                ...
                this.onWidgetsReordered().subscribe(this, ((t,e)=>{
                    if (r.LinetoolsFavoritesStore.favoriteMoved.unsubscribe(this, this._onFavoriteMoved),
            ...
            _loadVisibilityState() {
                ...
                o = "false" !== i,
                u.TVLocalStorage.setItem("ChartFavoriteDrawingToolbarWidget.visible", i)) : o = "false" !== u.TVLocalStorage.getItem("ChartFavoriteDrawingToolbarWidget.visible"),
    ...
    43066: (t,e,o)=>{
        "use strict";
        o.d(e, {
            FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: ()=>_,
            FloatingToolbar: ()=>f
        });
        var i = o(370981)
          , n = o(972535)
        ...
        class d extends c.ChunkLoader {
            _startLoading() {
                return Promise.all([o.e(1553), o.e(2377)]).then(o.bind(o, 177525)).then((t=>t.HammerJS))
            }
        }
        var h = o(131595)
          , p = o(496818)
        ...
        class f {
            constructor(t) {
                ...
                this._options.layout && "auto" !== this._options.layout && (this._isVertical = "vertical" === this._options.layout,
                this._updateLayoutType(),
                this._updateAxisOption()),
                this._options.autoCreate && (this._init(), document.body.appendChild(this._widget)),
            ...
            show() {
                this.isVisible() || (document.body.contains(this._widget) || (this._init(),
                ...
                this._widget.classList.contains("i-hidden") ? (this._widget.classList.remove("i-hidden"),
                setTimeout((()=>{
            ...
            hide(t=!1) {
                ...
                if (this._widget.classList.add("i-closed"),
            ...
            raise() {
                f._toolbars.length + f._startZIndex !== this._zIndex() && (f._toolbars.splice(f._toolbars.indexOf(this), 1),
                f._toolbars.push(this),
            ...
            checkPosition() {
                ...
                t.left === e.left && t.top === e.top || (this._widget.style.left = e.left + "px",
            ...
            _getSavedPosition() {
                ...
                if ("device" === this._options.positionStorageType) {
                    ...
                    e = null !== (t = (0,
                    s.getJSON)(this._options.positionSettingsKey)) && void 0 !== t ? t : null;
            ...
            _onWindowResize() {
                if ("auto" === (this._options.layout || "auto")) {
                    ...
                    this._updateLayoutType(),
                    t !== this._isVertical && (this._onVerticalChanged(this._isVertical, t),
                    this._updateAxisOption())
                }
                this.checkPosition(),
            ...
            _initSortable() {
                ...
                lazyJqueryUI(this._content).sortable({
                    ...
                    stop: (e,o)=>{
                        ...
                        t !== i && ((0,
                        m.trackEvent)("Floating Toolbar", "User Sort"),
    ...
    477693: (t,e,o)=>{
        ...
        class g extends (m()) {
            ...
            unsubscribe(t, e) {
                var o;
                const i = (0,
                p.ensureDefined)(null === (o = this._listenersMappers.find((o=>o.obj === t && o.method === e))) || void 0 === o ? void 0 : o.callback);
        ...
        function T(t) {
            const {templateButton: e, propertyButtons: o, commonButtons: n, isDrawingFinished: r, isToolbarFixed: s, buttonClassName: a, activeChartWidget: l} = t
            ...
            return c && c.length ? i.createElement(y.MatchMediaMap, {
            ...
            }, (({isSmallWidth: t, isSmallHeight: e})=>i.createElement(i.Fragment, null, d(), r && i.createElement(i.Fragment, null, Boolean(o.length) && o.map(((o,n)=>i.createElement(o.component, {
                ...o.props,
                ...
                const r = t || e;
                return r ? o.showForSmallScreen ? i.createElement(o.component, {
                    ...o.props,
                    isSmallScreen: r,
                    key: `${o.props.title}_ ${n}`,
                    className: f()(C, a)
                }) : null : i.createElement(o.component, {
                    ...o.props,
                    key: `${o.props.title}_ ${n}`,
                    className: f()(C, a)
                })
            ...
            function d() {
                return null === e ? null : i.createElement(e.component, {
                    ...e.props,
                    isToolbarFixed: s,
                    isDrawingFinished: r,
                    className: f()(C, a)
        ...
        function x(t) {
            ...
            return i.createElement(S.ToolWidgetIconButton, {
                ...
                onClick: async function() {
                    (0,
                    E.trackEvent)("GUI", "Context action on drawings", "Settings");
        ...
        function A(t) {
            ...
            return i.createElement(B, {
                ...
                onClick: function() {
                    (0,
                    E.trackEvent)("GUI", "Context action on drawings", "Lock"),
        ...
        function I(t) {
            ...
            return i.createElement(S.ToolWidgetIconButton, {
                ...
                onClick: function() {
                    (0,
                    E.trackEvent)("GUI", "Context action on drawings", "Remove"),
        ...
        function G(t, e) {
            const i = [(0,
            H.createVisualOrderAction)(t, e), (0,
            H.createChangeIntervalsVisibilitiesAction)(t, e)]
              , n = function(t, e) {
                const i = []
                  , n = U.isMacKeyboard ? " +" : ""
                ...
                s.length > 0 && i.push(new Z.Action({
                    ...
                    onExecute: ()=>{
                        ...
                        (0,
                        E.trackEvent)("GUI", "Context action on drawings", "Clone")
                    }
                }));
                ...
                H.createSyncDrawingActions)(t, e)),
                i) : i
            }(t, e);
            return n.length && i.push(new Z.Separator, ...n),
            i.push(new Z.Separator, function(t) {
                return new Z.Action({
        ...
        function Y(t) {
            ...
            i.useRef)(null)
              , d = (0,
            i.useMemo)((()=>new H.ActionsProvider(o)), [o])
              , h = (0,
            i.useCallback)((()=>d.contextMenuActionsForSources(s)), [d, s])
              , p = (0,
            i.useCallback)((()=>{
                if (n)
                    return;
            ...
            i.useCallback)((t=>{
                n && h().then((e=>{
                    window.matchMedia(b.DialogBreakpoints.TabletSmall).matches ? O.ContextMenuManager.showMenu(X(e), t, {
                        mode: "drawer",
                        "data-name": "more-menu"
                    }) : l(X(e))
                }
        ...
        class at extends w.FloatingToolbar {
            ...
            addGroupedWidget(t, e={}) {
                (0,
                p.assert)(t.states.length > 0 && -1 !== at._getStateIndexById(t, t.currentStateId), `Argument is invalid (count: ${t.states.length}, state: ${t.currentStateId})`);
            ...
            setGroupedWidgetState(t, e) {
                const o = this._ensuredGetWidgetDataForId(t);
                (0,
                p.assert)(-1 !== at._getStateIndexById(o.statedWidget, e), `Unknown stateId (${e})`),
            ...
            _updateWidgetPreview(t) {
                ...
                (0,
                p.assert)(-1 !== e, `Unknown state id: ${t.statedWidget.currentStateId}`);
                const o = t.statedWidget.states[e].widget.cloneNode(!0);
                t.toolbarWidget.firstChild ? t.toolbarWidget.replaceChild(o, t.toolbarWidget.firstChild) : (t.toolbarWidget.appendChild(o),
            ...
            _updatePopupPosition() {
                ...
                if (this.isVertical())
                    ...
                    r.style.left = "",
                    e.left > window.innerWidth - e.right ? r.classList.add("tv-grouped-floating-toolbar__popup--at-left") : r.classList.remove("tv-grouped-floating-toolbar__popup--at-left");
                else {
                    r.classList.remove("tv-grouped-floating-toolbar__popup--at-left");
                    let t = 0;
                    i.left + n.width > window.innerWidth ? e.left + n.width > window.innerWidth && (t = e.width - n.width) : t = i.left - e.left + 1,
                    r.style.left = `${t}px`,
                    e.bottom + n.height > window.innerHeight ? r.classList.add("tv-grouped-floating-toolbar__popup--at-top") : (r.classList.remove("tv-grouped-floating-toolbar__popup--at-top"),
                    r.style.top = "")
                }
            }
            ...
            _onSubWidgetClicked(t, e) {
                this._closePopup(),
                t.statedWidget.currentStateId !== e && (this.setGroupedWidgetState(t.statedWidget.id, e),
            ...
            static _createCaret() {
                ...
                return t.className = "tv-caret tv-caret--small tv-caret--colored tv-grouped-floating-toolbar__caret",
                t
            }
            static _prepareOptions(t) {
                const e = " tv-grouped-floating-toolbar";
                return t.addClass ? t.addClass += e : t.addClass = e,
                t
            }
        ...
        var lt = o(632863)
          ...
          , ut = o(608280);
        function mt(t) {
            const {model: e, onRestore: n, onSave: s, isDrawingFinished: a, isToolbarFixed: l, className: c, ...d} = t
              , [h,p] = (0,
            i.useState)(!1)
              , [u,m] = (0,
            i.useState)(null)
            ...
            i.useMemo)((()=>{
                const t = [];
                return a && _ && t.push(new Z.Action({
                    actionId: "Chart.LineTool.Templates.SaveAs",
                    label: (0,
                    ht.appendEllipsis)(r.t(null, void 0, o(933751))),
                    onExecute: _
                })),
                t.push(new Z.Action({
                ...
                h ? t.push(new Z.Loader("Chart.LineTool.Templates.Apply")) : !h && (null == u ? void 0 : u.length) && (t.push(new Z.Separator),
                t.push(...u.map((t=>new Z.Action({
            ...
            return i.createElement(V.ToolWidgetMenu, {
                ...
                onOpen: function() {
                    ...
                    (0,
                    E.trackEvent)("GUI", "Context action on drawings", "Templates")
                },
                arrow: !1,
                className: c,
                "data-name": "templates",
        ...
        var gt = o(602164)
          ...
          , vt = o(955643)
          , ft = o(946839);
        const yt = (!a.enabled("widget") || window.is_authenticated) && a.enabled("linetoolpropertieswidget_template_button")
          , wt = !1
        ...
        class Lt {
            constructor(t) {
                ...
                this._handleSourceEdit = t=>{
                    d.isDirectionalMovementActive.value() || (t ? (this._fixedContainer && (this._fixedContainer.style.display = "none"),
                    this._floatingToolbar.hide(!0)) : (this._fixedToolbarRendered && this._fixedContainer && (this._fixedContainer.style.display = "block"),
            ...
            onSourceChanged(t) {
                if (!(null == t ? void 0 : t.length))
                    return this._propertiesVisible = !1,
                    this._toolbarVisible = !1,
                    void this.hide();
                if (this._createCommonButtons(),
                t.every((e=>e.toolname === t[0].toolname)) ? this._showTemplatesOf({
                    sources: t
                }) : this._templatesButton && this._clearTemplatesButton(),
                1 === t.length) {
                    const e = t[0];
                    e.isAvailableInFloatingWidget() && this.activeChartWidget().model().model().dataSourceForId(e.id()) ? (!e.userEditEnabled() || !(0,
                    _t.isLineDrawnWithPressedButton)(e.toolname) && this.activeChartWidget().model().lineBeingCreated() || this._isDrawingFinished.setValue(!0),
            ...
            hide() {
                ...
                this._updateVisibilityTimeout = setTimeout((()=>{
                    (0,
                    ct.unsetNewToolProperties)(),
                    Dt() && this._fixedContainer ? this._fixedContainer.style.display = "none" : this._floatingToolbar.hide(!0),
            ...
            _onToolChanged(t, e) {
                ...
                if (this._isDrawingToolExcludingCustomUrlEventTool(t)) {
                    if (this._isDrawingFinished.setValue(!1),
                    yt) {
                        const o = e instanceof gt.DefaultProperty ? e : (0,
                        ct.setNewToolProperties)(t, "LineToolIcon" === t ? d.iconTool.value() : "LineToolEmoji" === t ? d.emojiTool.value() : void 0, this._chartWidgetCollection.activeChartWidget.value().model().model());
                    ...
                    o && o.length ? (o.length > 1 && this._isDrawingFinished.setValue(!0),
                    this.onSourceChanged(this.selectedSources())) : this.hide()
            }
            _propertyApplierImpl() {
                return this._propertyApplier || (this._propertyApplier = new ft.PropertyApplierWithoutSavingChart((()=>this.activeChartWidget().model()),new l.WatchedValue(!0))),
                this._propertyApplier
            }
            _clearProperties() {
                this._clearPropertyButtons(),
                this._lineWidthsProperty && (this._lineWidthsProperty.destroy(),
                this._lineWidthsProperty = null),
                this._lineColorsProperty && (this._lineColorsProperty.destroy(),
                this._lineColorsProperty = null),
            ...
            _show() {
                ...
                this._updateVisibilityTimeout = setTimeout((()=>{
                    this._renderToolbar(),
                    Dt() && this._fixedContainer ? this._fixedContainer.style.display = "block" : (this._floatingToolbar.show(),
                    this._floatingToolbar.checkPosition())
                }
                ), 0)
            }
            _addPropertyButton(t) {
                this._propertyButtons.push(t),
                this._renderToolbar()
            }
            _addCommonButton(t) {
                this._commonButtons.push(t),
                this._renderToolbar()
            }
            ...
            _unmountFloatingToolbar() {
                null !== this._floatingContainer && (n.unmountComponentAtNode(this._floatingContainer),
                this._floatingToolbarRendered = !1)
            }
            ...
            _createLineStyleButton(t) {
                ...
                return this._addPropertyButton(i),
                !0
            }
            ...
            _createProperty(t, e, o, i) {
                if (e) {
                    ...
                    if (!t)
                        return;
                    return this._isWidthProperty(t[0]) ? new g(new h.MultipleLineWidthsProperty(t),this._propertyApplierImpl(),i) : new _.CollectibleColorPropertyUndoWrapper(new h.MultipleLineColorsProperty(t),this._propertyApplierImpl(),i)
                }
                if (t && t.visible())
                    return this._isWidthProperty(t) ? new h.MultipleLineWidthsProperty([t]) : new _.CollectibleColorPropertyDirectWrapper(new h.MultipleLineColorsProperty([t]))
            }
            ...
            _updateVisibility() {
                (yt && !Dt() || this._isDrawingFinished.value()) && (this._toolbarVisible || this._propertiesVisible) ? this._show() : this.hide()
            }
            _showTemplatesOf(t) {
                if (!a.enabled("drawing_templates"))
                    return;
                if (this._templatesButton && this._clearTemplatesButton(),
                !yt)
                    return;
                let e, o, i, n;
                if ("sources"in t) {
                ...
                this._addTemplatesButton({
                    ...
                    props: {
                        ...
                        onSave: n,
                        onRestore: ()=>{
                            void 0 !== e ? this.activeChartWidget().model().restoreLineToolsFactoryDefaults(e) : i.restoreFactoryDefaults(),
                            this.refresh()
                        }
                    }
                })
            ...
            _unmountFixedToolbar() {
                null !== this._fixedContainer && (n.unmountComponentAtNode(this._fixedContainer),
                this._fixedToolbarRendered = !1)
            }
            _unmountToolbar() {
    ...
    580384: (t,e,o)=>{
        ...
        class d {
            ...
            loadTemplate(t, e) {
                n.store.dispatch((0,
                r.loadTemplate)(this._toolName, t, (t=>{
            ...
            removeTemplate(t) {
                n.store.dispatch((0,
                r.startRemoveTemplate)(this._toolName, t))
            }
            saveTemplate(t, e) {
                const o = (0,
                s.clean)(t);
                n.store.dispatch((0,
                r.saveTemplate)(this._toolName, o, e))
            }
            deleteAction(t) {
                (0,
                a.runOrSignIn)((()=>{
            ...
            async _loadData() {
                return new Promise((t=>{
                    this.getData() ? t() : n.store.dispatch((0,
                    r.getTemplates)(this._toolName, t))
                }
                ))
            }
        }
    ...
    227009: (t,e,o)=>{
        ...
        class L extends n {
            ...
            _createWidthsButton(t, e) {
                if (this._lineWidthsProperty && (this._lineWidthsProperty.destroy(),
                this._lineWidthsProperty = null),
            ...
            _createColorsButton(t, e) {
                return this._lineColorsProperty && (this._lineColorsProperty.destroy(),
                this._lineColorsProperty = null),
                this._lineColorsProperty = this._createProperty(t, e, "linesColors", d),
                !this._lineColorsProperty || (this._addPropertyButton({
                    component: r,
                    props: {
                        icon: a,
                        title: g,
            ...
            _createBackgroundsButton(t, e) {
                return this._backgroundsProperty && (this._backgroundsProperty.destroy(),
                this._backgroundsProperty = null),
                this._backgroundsProperty = this._createProperty(t, e, "backgroundsColors", h),
                !this._backgroundsProperty || (this._addPropertyButton({
                    component: r,
                    props: {
                        icon: l,
                        title: y,
            ...
            _createTextColorsButton(t, e) {
                return this._textColorsProperty && (this._textColorsProperty.destroy(),
                this._textColorsProperty = null),
                this._textColorsProperty = this._createProperty(t, e, "textsColors", p),
                !this._textColorsProperty || (this._addPropertyButton({
                    component: r,
                    props: {
                        icon: c,
                        title: v,
                ...
                i.length) {
                    for (var n = {}, s = 0; s < i.length; s++) {
                        ...
                        if ("function" != typeof h || h(l, e)) {
                            var p = a.factory;
                            if (p && p.call(this, l, o))
                                continue;
                            if (!l)
                                continue;
                            if (this._propertiesVisible = !0,
    ...
    986661: (t,e,o)=>{
        ...
        var h = o(362830);
        const p = (0,
        l.getLogger)("Chart.LineToolTemplatesList");
        function u(t, e) {
            return e
        }
        function *m() {
            for (; ; ) {
                const {toolName: t, templateName: e, content: o} = u(a.SAVE_TEMPLATE, yield(0,
                r.take)(a.SAVE_TEMPLATE));
                try {
                    yield(0,
                    r.call)(h.backend.saveDrawingTemplate, t, e, o),
                    yield(0,
                    r.put)((0,
                    c.addTemplate)(t, e))
                } catch (t) {
        ...
        function *g() {
            for (; ; ) {
                const {toolName: t, templateName: e} = u(a.START_REMOVE_TEMPLATE, yield(0,
                r.take)(a.START_REMOVE_TEMPLATE));
                try {
                    yield(0,
                    r.call)(h.backend.removeDrawingTemplate, t, e),
                    yield(0,
                    r.put)((0,
                    c.removeTemplate)(t, e))
                } catch (t) {
                    p.logWarn(t)
                }
            }
        ...
        function *_() {
            const t = new Map;
            for (; ; ) {
                const {toolName: o, callback: i} = u(a.GET_TEMPLATES, yield(0,
                r.take)(a.GET_TEMPLATES));
                t.has(o) ? (0,
                s.ensureDefined)(t.get(o)).push(i) : (t.set(o, [i]),
                yield(0,
                r.fork)(e, o))
            }
            function *e(e) {
                try {
                    const t = d(h.backend.getDrawingTemplates, yield(0,
                    r.call)(h.backend.getDrawingTemplates, e));
                    yield(0,
                    r.put)((0,
                    c.setTemplates)(e, t))
                } catch (t) {
                ...
                (0,
                s.ensureDefined)(t.get(e)).forEach((t=>null == t ? void 0 : t())),
                t.delete(e)
            }
        }
        function *v() {
            for (; ; ) {
                const {toolName: t, templateName: e, callback: o} = u(a.LOAD_TEMPLATE, yield(0,
                r.take)(a.LOAD_TEMPLATE));
                try {
                    const i = d(h.backend.loadDrawingTemplate, yield(0,
                    r.call)(h.backend.loadDrawingTemplate, t, e));
                    o && o(i)
                } catch (t) {
                    p.logWarn(t)
                }
    ...
    29742: (t,e,o)=>{
        ...
        class s extends (r()) {
            ...
            unsubscribe(t, e) {
                var o;
                const n = (0,
                i.ensureDefined)(null === (o = this._listenersMappers.find((o=>o.obj === t && o.method === e))) || void 0 === o ? void 0 : o.callback);
