...
export default {
  ...
  mounted() {
    ...
    tvWidget.onChartReady(() => {
      ...
      tvWidget.headerReady().then(function () {
        ...
        // var buttonBot = tvWidget.createButton();
        // buttonBot.setAttribute("title", "SMT Bot");
        // buttonBot.setAttribute("class", "cus-smt-bot");
        // buttonBot.setAttribute("style", "cursor: pointer;");
        // buttonBot.addEventListener("click", function () {});
        // buttonBot.textContent = "SMT Bot";
        tvWidget
          .createDropdown({
            title: "SMT Bot",
            tooltip: "SMT Bot",
  ...
  beforeDestroy() {
    clearInterval(this.runrot);
    if (this.tvWidget && this.tvWidget !== null) {
