...
<script>
import { tvchartSV } from './tvchart.service'
var signal = NaN
let tvWidget
        ...
        return Promise.resolve([
          ...
          // Phai Sinh trend
          {
            ...
            metainfo: {
              ...
              linkedToSeries: true,
              isTVScript: false,
              id: 'SMT PS Trend+@tv-basicstudies-1',
          ...
          // Phai Sinh 3m
          {
            ...
            metainfo: {
              _metainfoVersion: 51,
              description: 'SMT 3M',
              shortDescription: 'SMT 3M',
              is_hidden_study: false,
              is_price_study: true,
              isCustomIndicator: true,
              linkedToSeries: true,
              isTVScript: false,
              id: 'SMT 3M@tv-basicstudies-1',
